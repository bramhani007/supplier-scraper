...
CREATE INDEX IF NOT EXISTS idx_suppliers_status   ON suppliers (scrape_status);
...
CREATE INDEX IF NOT EXISTS idx_jobs_created ON scraping_jobs (created_at DESC);